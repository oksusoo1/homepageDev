...
코드: `lib/flow-step.js` · 공통코드 `FLOW_STEP` ON
...
| FLOW | 공개 |
|------|------|
| intake · deposit · building | 제작하는 사람만 |
...
| 견적 | deposit | `dev_fee_total` |
| 선금 확인 | building | `down_paid_at` |
| 검수 공개 | preview | — |
| 잔금 신청 | balance | OTP `pending_confirm` |
| 잔금 확인 | pay_method | `final_paid_at` · OTP paid |
